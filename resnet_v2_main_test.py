...
import resnet_v2_image_process_test as resnet_v2_image_process
...
def parse_arguments(argv):
    ...
    parser.add_argument('--label_file', type=str,
                        help='标签文件', default='model/labels_309_4_10.txt')
    parser.add_argument('--model_file', type=str,
                        help='模型文件(proto)', default='model/inception_resnet_v2_behaviour_309_4_10_434k.pb')
    ...
    parser.add_argument('--save_path', type=str,
                        help='结果保存路径', default='behaviour_309_4_10_434k_new')
