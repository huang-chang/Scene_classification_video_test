...
file: mian.py
data: 2017.8.11
note: scene classification gui tool
"""
...
import resnet_v2_image_process_split as resnet_v2_image_process
...
def parse_arguments(argv):
    ...
    parser.add_argument('--model_file', type=str,
                        help='模型文件(proto)', default='model/inception_resnet_v2_behaviour_337_5_22_411k_split.pb')
    ...
    parser.add_argument('--save_path', type=str,
                        help='结果保存路径', default='behaviour_337_5_22_411k_split')
